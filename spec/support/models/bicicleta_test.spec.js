...
describe('Bicicleta.add',()=>{
    it('agregamos una',()=>{
        ...
        var a = new Bicicleta(1, 'rojo', 'urbana', [-31.416668,-64.183334]);
        Bicicleta.add(a);
...
describe('Bicicleta.findBy',()=>{
    it('debe devolver la bici con ID 1',()=>{
        ...
        var aBici2= new Bicicleta(2,"rojo","bmx")
        Bicicleta.add(aBici)
...
describe('Bicicleta.removeById',()=>{
    it('debe remover la bici con ID 1',()=>{
        ...
        expect(targetBici=Bicicleta.findById(1)).toBe(Error(`No existe una bici con id ${aBici}`))
